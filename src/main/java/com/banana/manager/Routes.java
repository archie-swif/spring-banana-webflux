...
import com.banana.manager.event.ReactiveKafkaEventHandler;
...
public class Routes {
    ...
    @Bean
    public RouterFunction<ServerResponse> router(ReactiveKafkaEventHandler eventHandler) {
        ...
        return RouterFunctions
                ...
                .route(POST("/user"), serverRequest -> {
                    ...
                    Mono<String> sender = serverRequest.bodyToMono(User.class)
                            ...
                            .doOnNext(eventHandler::sendTodo)
                            .flatMap(b -> bridge);
